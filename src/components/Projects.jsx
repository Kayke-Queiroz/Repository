...
const projects = [
    {
        ...
        github: "https://github.com/Kayke-Queiroz",
        url: "#",
...
const ProjectCard = ({ project, index, x }) => {
        ...
        <section id="projetos" className="relative h-[800px] w-full flex flex-col items-center justify-center overflow-hidden py-20">
            ...
            <div className="z-10 text-center pointer-events-none mb-16 px-4">
                ...
                <p className="text-gray-400 mt-6 max-w-2xl mx-auto text-lg">
                    Explore algumas das soluções que desenvolvi, variando de aplicações web complexas a automações inteligentes.
                </p>
            </div>
